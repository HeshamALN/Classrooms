...
def student_create(request, classroom_id):
	...
	if request.iser != classroom_obj.teacher:
...
def student_delete(request, classroom_id, student_id):
	...
	Student.objects_get(id=student_id).delete()
	return redirect('classroom-detail', classroom_id)
...
def classroom_detail(request, classroom_id):
	...
	students = classroom.student_set.all().order_by("name", "exam_grades")
	context = {
		"classroom": classroom,
		"students": students
	}
...
def signup (request):
	...
	return render(request, 'siginup.html', context)
